...
TEST_SRC := src/common/rename.lua src/common/util.lua src/common/enum.lua \
...
STG_SRC := src/common/rename.lua src/common/util.lua src/common/enum.lua \
           ...
           src/stg/motion.lua src/stg/motiontypes.lua \
           src/stg/pattern.lua src/stg/patterns.lua \
           src/stg/shot.lua src/stg/shots.lua \
