...
STG_SRC := src/common/rename.lua src/common/util.lua src/common/help.lua \
           ...
           src/stg/addremove.lua src/stg/bomb.lua src/stg/bombs.lua \
           src/stg/pattern.lua src/stg/patterns.lua src/stg/shot.lua \
           src/stg/shots.lua src/stg/player.lua src/stg/data.lua \
           src/stg/help.lua src/stg/commands.lua src/stg/events.lua \
           src/stg/main.lua
